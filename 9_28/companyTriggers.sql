...
-- IMPORTANT** delimiter // tells MySQL that ; is no longer the statement delimiter; the statement delimiter is //
delimiter //  
...
BEGIN
    ...
    -- assume that the employees table has this default_essn
